...
public class ThresholdEditingSupport extends EditingSupport
{
	...
	public ThresholdEditingSupport(TableViewer selectedFileViewer, ManageDatabaseDialog a_manageDatabaseDialog)
	{
	...
	{
		if (((SelectedFileViewer) element).getThreshold() == null)
		{
			return "";
		}
		else
			return ((SelectedFileViewer) element).getThreshold().toString();
	}
	...
	protected void setValue(Object element, Object userInputValue)
	{
		...
		Double enteredThreshold = null;
		try
		{
			enteredThreshold = Double.parseDouble(String.valueOf(userInputValue));
		}
		catch (NullPointerException e)
		{
			((SelectedFileViewer) element).setThreshold(enteredThreshold);
